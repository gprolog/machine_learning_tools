...
train_test_mal_sample_path = os.path.join(cfg['auto_by_engine']['train_test_set_path'], 'mal_set')
train_test_nor_sample_path = os.path.join(cfg['auto_by_engine']['train_test_set_path'], 'nor_set')
