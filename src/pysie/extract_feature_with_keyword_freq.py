...
class FeatureExtractor:
	...
	self.only_html_keywords = self.auto_cfg['auto_by_python']['only_html_keyword']        
	...
	#if self.only_html_keywords:
	#    print 'only need html keyword'
        #    self.extract_html_features(file_path, content)
        #    self.keyword_feature_extractor.analyze_content(content, self.topn)
        #    self.features.update(self.keyword_feature_extractor.get_features_index_frequency())
	#    return
